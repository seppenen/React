    ...
    <div>
      <AppBar position='static'>
        <Toolbar>
          ...
          <Typography variant='h5'>Valikko</Typography>
        </Toolbar>
      </AppBar>
...
<ListItemText primary='Sanalasku' /> </ListItem>

<ListItem button>
        <ListItemIcon><CreateIcon /></ListItemIcon>
<ListItemText primary='Listaa' /> </ListItem>

<ListItem button>
        <ListItemIcon><ListIcon /></ListItemIcon>
<ListItemText primary='Lisää' /> </ListItem>
